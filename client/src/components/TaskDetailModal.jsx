...
// We don't need moment.js if we use built-in browser functions

const TaskDetailModal = ({ task, isOpen, onClose }) => {
  if (!isOpen || !task) return null;

  // --- NEW: Helper function to format dates correctly ---
          ...
          <div className="mt-6 border-t border-gray-200 pt-6">
            <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
              ...
              <div className="sm:col-span-1">
                ...
                <dd className="mt-1 text-sm text-gray-900">{formatLocalDateTime(task.dueDate)}</dd>
              </div>
              <div className="sm:col-span-1">
                <dt className="text-sm font-medium text-gray-500">Created</dt>
                <dd className="mt-1 text-sm text-gray-900">{formatLocalDate(task.createdAt)}</dd>
              </div>
