...
const { 
    askAboutDash, 
    processAiCommand // This replaces the old createTaskFromText
...
// @desc    Process a natural language "action" command (Create, Read, Update, Delete)
router.post('/command', processAiCommand);
